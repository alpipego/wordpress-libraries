...
class CreateCt {
	...
	/**
	 * CreateCt constructor.
	 *
	 * @param $taxonomy
	 * @param $singular
	 * @param $plural
	 * @param null $objects
	 * @param array $supports [$public|$show_ui|$show_in_menu]
	 * @param array $rewrite
	 */
	public function __construct( $taxonomy, $singular, $plural, $objects = [], $supports = [], $rewrite = [], $capabilities = [] ) {
	...
	public function capabilities( $capabilities ) {
		...
		return array_merge( $defaults['capabilities'], $capabilities );
	}
	...
	public function register() {
		$args            = $this->supports;
		$args            = array_merge( $args, $this->capabilities );
